<template>
  ...
  <span v-if="canModify">
    <router-link data-cy="article-edit" class="btn btn-sm btn-outline-secondary" :to="editArticleLink">
      <i class="ion-edit"></i> <span>&nbsp;Edit Article</span>
    </router-link>
    <span>&nbsp;&nbsp;</span>
    <button data-cy="article-delete" class="btn btn-outline-danger btn-sm" @click="deleteArticle">
